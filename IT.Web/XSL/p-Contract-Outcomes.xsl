  ...
  <xsl:template match="Contract">
    ...
    <TABLE BORDER="0" CELLSPACING="5" CELLPADDING="0" WIDTH="100%">
      <TBODY>
            ...
            <TD>
              <NOBR>
                <B STYLE="font:bold 11px;">
                  Итого фактичеки выплачено: <B STYLE="font:bold 12px; color:green;">
                    <xsl:value-of select="$OutcomeFactSum"/> с НДС
                  </B>
                </B>
              </NOBR>
            </TD>
        ...
        <!--Отобразим только плановые платежи-->
        <xsl:for-each select="Outcomes">
          <TR>
            <TD class="x-editor-text x-editor-propcaption">
              <NOBR>Платежи по плану:</NOBR>
            </TD>
          </TR>
          ...
          <TR>
            <TD>
              <NOBR>
                <B STYLE="font:bold 11px;">
                  Итого запланировано: <B STYLE="font:bold 12px; color:green;">
                    <xsl:value-of select="$OutcomePlanSum"/> с НДС
                  </B>
                </B>
              </NOBR>
            </TD>
