...
<!--
===============================================================================
	1-я страница параметров отчета "Список участников и затрат проекта"
-->
			...
			<tr>
				...
				<td>
					<table width="100%" border="0" cellspacing="1" cellpadding="0">
						<tr>
							<td>
								<xsl:for-each select="ShowColumnTasksDone">
									<xsl:call-template name="std-template-bool">
										<xsl:with-param name="label">Выполненные задания</xsl:with-param>
									</xsl:call-template>
								</xsl:for-each>
							</td>
							<td>
								<xsl:for-each select="ShowColumnTasksLeft">
									<xsl:call-template name="std-template-bool">
										<xsl:with-param name="label">Оставшиеся задания</xsl:with-param>
									</xsl:call-template>
								</xsl:for-each>
							</td>
						</tr>
						<tr>
							<td>
								<xsl:for-each select="ShowColumnLostTime">
									<xsl:call-template name="std-template-bool">
										<xsl:with-param name="label">Списанное время</xsl:with-param>
									</xsl:call-template>
								</xsl:for-each>
							</td>
							<td>
								<xsl:for-each select="ShowColumnSpentTime">
									<xsl:call-template name="std-template-bool">
										<xsl:with-param name="label">Затраченное время</xsl:with-param>
									</xsl:call-template>
								</xsl:for-each>
							</td>
						</tr>
						<tr>
							<td>
								<xsl:for-each select="ShowColumnPlannedTime">
									<xsl:call-template name="std-template-bool">
										<xsl:with-param name="label">Запланированное время</xsl:with-param>
									</xsl:call-template>
								</xsl:for-each>
							</td>
							<td>
								<xsl:for-each select="ShowColumnSummaryTime">
									<xsl:call-template name="std-template-bool">
						...
						<tr>
							<td>
								<xsl:for-each select="ShowColumnLeftTime">
									<xsl:call-template name="std-template-bool">
										<xsl:with-param name="label">Оставшееся время</xsl:with-param>
									</xsl:call-template>
								</xsl:for-each>
							</td>
							<td />
