...
<!-- 
********************************************************************************
	Страница редактора временного объекта FilterDKP для фильтра иерархии "Клиенты и проекты".
	Редактор открывается в отдельном диалоговом окне.
********************************************************************************
-->
...
<TABLE CELLSPACING="2" CELLPADDING="0" CLASS="x-layoutgrid x-filter-layoutgrid" STYLE="width:100%; height:100%;">
	<TR>
		...
		<TD ROWSPAN="15" width="80%" height="100%"><SPAN style="margin-left:5px;">Направления:</SPAN><BR/>
