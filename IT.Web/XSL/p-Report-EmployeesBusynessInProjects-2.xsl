...
<!--
===============================================================================
	2-я страница параметров отчета "Занятость сотрудников в проектах"
-->
			...
			<tr>
				...
				<td>
					<table width="100%" border="0" cellspacing="1" cellpadding="0">
						<tr>
							<td>
								<xsl:for-each select="ShowColumnCustomer">
									<xsl:call-template name="std-template-bool">
										<xsl:with-param name="label">Аккаунт</xsl:with-param>
									</xsl:call-template>
								</xsl:for-each>
							</td>
						</tr>
						<tr>
							<td>
								<xsl:for-each select="ShowColumnExpenses">
									<xsl:call-template name="std-template-bool">
										<xsl:with-param name="label">Трудозатраты, время</xsl:with-param>
									</xsl:call-template>
								</xsl:for-each>
							</td>
						</tr>
