...
<xsl:stylesheet version="1.0"
  ...
  <xsl:template match="OutDoc">
    <table BORDER="0" CELLSPACING="10" CELLPADDING="0" WIDTH="100%">
      ...
      <tr>
        <td class="x-editor-text x-editor-propcaption">Расходный договор:</td>
        <td>
          <xsl:for-each select="OutContract">
            <xsl:call-template name="std-template-object">
            </xsl:call-template>
          </xsl:for-each>
        </td>
      ...
      <tr>
        <td class="x-editor-text x-editor-propcaption">Договор:</td>
        <td>
      ...
      <tr height="150">
        <td valign="top" class="x-editor-text x-editor-propcaption">Расходы:</td>
        <td>
