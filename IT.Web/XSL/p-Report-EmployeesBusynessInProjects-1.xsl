...
<!--
===============================================================================
	1-я страница параметров отчета "Занятость сотрудников в проектах"
-->
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:XService="urn:x-client-service" xmlns:q="urn:query-string-access" xmlns:d="urn:object-editor-access" xmlns:w="urn:editor-window-access" xmlns:b="urn:x-page-builder" xmlns:msxsl="urn:schemas-microsoft-com:xslt">
	...
	<xsl:template match="FilterReportEmployeesBusynessInProjects">
		<table width="100%" border="0" cellspacing="2" cellpadding="0">
			...
			<tr>
				<td class="x-editor-text x-editor-propcaption">Виды трудозатрат:</td>
				<td>
					<xsl:for-each select="ExpencesType">
			...
			<tr>
				<td />
				<td>
					<xsl:for-each select="CauseDetalization">
						<xsl:call-template name="std-template-bool">
							<xsl:with-param name="label">Детализация по причинам списания</xsl:with-param>
						</xsl:call-template>
					</xsl:for-each>
				</td>
			</tr>
