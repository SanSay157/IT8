...
{
	partial class DeliveryServiceInstaller
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			// serviceInstaller
			// 
			this.serviceInstaller.DisplayName = "Croc.IncidentTracker.Notification.DeliveryService";
			this.serviceInstaller.ServiceName = "Croc.IncidentTracker.Notification.DeliveryService";
			// 
